...
class TheoryParams(object):
    ...
    def __init__(self):
        ...
        nuisance     = ['gamma_b1cB', 'gamma_b1sA', 'gamma_b1sB', 'delta_sigsA', 'delta_sigsB', 'f1h_sBsB', 'f1h_cBs', 'epsilon']
        ...
        self.epsilon  = AttrDict(vary=False, fiducial=0., prior='uniform', lower=-1., upper=1., min=-1)
